...
| [`examples/ticket_triage.py`](https://github.com/TanbirRamim/callm/blob/main/examples/ticket_triage.py) | yes | a complete mini-project: support-ticket triage with validation, caching, PII masking and a cost report |
